                    ...
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="course_name" required>
                                ...
                                <?php
                                $q = mysqli_query($conn, "SELECT DISTINCT course_name FROM `courses_list`");
                                while ($row = mysqli_fetch_assoc($q)) {
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="selected_course" required>
                                ...
                                <?php
                                $q = mysqli_query($conn, "SELECT course_id, subject_name, subject_code FROM `courses` WHERE dept_name = 'FOCBS'");
                                while ($row = mysqli_fetch_assoc($q)) {
