...
// Fetch teacher credentials if not cached
...
$meta_query = "SELECT subject_code, course_name, year, semester FROM `subjected_teacher` WHERE teacher_id = '$id' AND subject_name = '$subject_name' LIMIT 1";
...
<head>
    ...
    <style>
        ...
        .session-banner { background: #ffffff; border-left: 5px solid #0d6efd; border-radius: 8px; }
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow py-2">
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-center ms-auto">
                    <span class="navbar-text text-white bg-secondary bg-opacity-25 border border-secondary px-3 py-1 rounded-pill small me-3 d-none d-sm-inline">
                        <i class="fa-solid fa-user-tie me-1 text-warning"></i> Prof. <?php echo htmlspecialchars($teacher_name); ?>
                    </span>
                    <a href="index.php" class="btn btn-sm btn-outline-info me-2"><i class="fa-solid fa-house me-1"></i> Home</a>
            ...
            <div class="col-md-11 col-lg-9">
                ...
                <div class="session-banner card shadow-sm p-4 mb-4">
                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                        <div>
                            <span class="badge bg-primary mb-2 font-monospace tracking-wide"><?php echo htmlspecialchars($subject_code); ?></span>
                            <h3 class="fw-bold text-dark mb-1"><?php echo htmlspecialchars($subject_name); ?></h3>
                            <p class="text-muted mb-0 small">
                                <i class="fa-solid fa-square-poll-horizontal me-1"></i> <strong><?php echo htmlspecialchars($course_name); ?></strong> 
                                <span class="mx-2 text-black-50">|</span> Year: <?php echo htmlspecialchars($year); ?> 
                                <span class="mx-2 text-black-50">|</span> Sem: <?php echo htmlspecialchars($semester); ?>
                            </p>
                        </div>
                        <div class="text-end">
                ...
                <form action="save_attendance.php" method="POST">
                    ...
                    <input type="hidden" name="date_of_attendance" value="<?php echo htmlspecialchars($date_of_attendance); ?>">
                        ...
                        <table class='table table-striped table-hover table-bordered text-center align-middle mb-0'> 
                            <thead class='table-dark'>
                                <tr>
                                    ...
                                    <th style="width: 35%;">Attendance Status (Checked = Present)</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                // Restored your exact original database query logic to prevent column mismatch errors
                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    ...
                                    echo "<tr><td colspan='3' class='text-muted py-4'><i class='fa-solid fa-folder-open me-2'></i>No student records found in the database.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
                    ...
                    <div class="text-center my-4">
                        <button type="submit" name="insert_attendance" class="btn btn-success btn-lg px-5 shadow fw-bold"><i class="fa-solid fa-floppy-disk me-2"></i>Save Attendance</button>
                    </div>
                </form>
