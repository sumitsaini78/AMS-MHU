...
// 2. Enforce fallback fallback routing states if subject parameters missing
...
// 3. Query to calculate total days and present days per student for the selected subject
$query = "SELECT 
            s.name, 
            s.roll_number,
    ...
    <main class="container py-5">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
                ...
                <!-- Performance Deck Wrapper Container -->
                <div class="custom-card shadow-sm p-4 border border-light">
                    
                    <!-- Subject Info Header Block -->
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-4 flex-wrap gap-2">
                        ...
                        <div class="text-md-end">
                            <p class="text-muted small mb-0"><i class="fa-solid fa-circle-info text-info me-1"></i> Quick Action:</p>
                            <span class="small fw-medium text-secondary">Click on any student's name to view their <strong>Attendance Calendar</strong>.</span>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    // Assign conditional theme formatting components
                                    if ($raw_pct >= 75) {
                                    ...
                                    // Make Student Clickable using a styled form action button
                                    echo "<td>";
                                    ...
                                    // Visual Progress metric layout column
                                    echo "<td>";
                                    if ($total > 0) {
                                    ...
                                    // Final aggregate contextual calculation badge column
