    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm py-2">
            <div class="container-fluid">
                <a class="navbar-brand text-warning fw-bold fs-4" href="index.php"><i
                        class="fa-solid fa-graduation-cap me-2"></i>MOTHERHOOD UNIVERSITY</a>
                <div class="d-flex align-items-center gap-3">
                    <span class="text-white small"><i class="fa-solid fa-user me-1 text-warning"></i>
                        <?php echo htmlspecialchars($teacher_name); ?></span>
                    <a href="index.php" class="btn btn-sm btn-outline-info"><i class="fa-solid fa-house me-1"></i>
                        Dashboard</a>
                </div>
            </div>
        </nav>
            ...
            <div class="col-12 col-lg-10">
                ...
                <ul class="nav nav-pills mb-4 justify-content-center" id="correctionTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo $active_tab === 'single' ? 'active' : ''; ?>" id="single-tab"
                            data-bs-toggle="pill" data-bs-target="#singleCorrection" type="button" role="tab">
                            <i class="fa-solid fa-user me-2"></i>Single Record Correction
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link <?php echo $active_tab === 'bulk' ? 'active' : ''; ?>" id="bulk-tab"
                            data-bs-toggle="pill" data-bs-target="#bulkCorrection" type="button" role="tab">
                ...
                <div class="tab-content" id="correctionTabsContent">
                    ...
                    <div class="tab-pane fade <?php echo $active_tab === 'single' ? 'show active' : ''; ?>"
                        id="singleCorrection" role="tabpanel">
                        <!-- Single Search Card -->
                        <div class="form-card card p-4 mb-4">
                            <h4 class="fw-bold text-dark mb-3"><i
                                    class="fa-solid fa-magnifying-glass me-2 text-primary"></i>Find Single Attendance
                                Row</h4>
                            <form method="POST" action="request_correction.php">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold small text-secondary">STUDENT ROLL
                                            NUMBER</label>
                                        <input type="text" name="roll_number" class="form-control"
                                            placeholder="e.g., 26CSE001" required
                                            value="<?php echo isset($_POST['roll_number']) ? htmlspecialchars($_POST['roll_number']) : ''; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold small text-secondary">DATE OF ATTENDANCE
                                            (DDMMYY format)</label>
                                        <input type="text" name="date_of_attendance" class="form-control"
                                            placeholder="e.g., 130726" required
                                            value="<?php echo isset($_POST['date_of_attendance']) ? htmlspecialchars($_POST['date_of_attendance']) : ''; ?>">
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" name="search_attendance"
                                            class="btn btn-primary w-100 fw-bold"><i
                                                class="fa-solid fa-search me-2"></i>Fetch Attendance Row</button>
                                    </div>
                                </div>
                            </form>
                            <?php if (!empty($search_error)) {
                                echo "<div class='alert alert-danger mt-3 small py-2'>$search_error</div>";
                            } ?>
                        </div>
                        ...
                        <?php if ($attendance_record !== null) { ?>
                            <div class="form-card card p-4 border border-warning-subtle">
                                <h4 class="fw-bold text-warning mb-3"><i class="fa-solid fa-pen-to-square me-2"></i>Submit
                                ...
                                <div class="alert alert-secondary bg-light text-dark small mb-4">
                                    ...
                                    Current Status: <span
                                        class="badge bg-secondary"><?php echo htmlspecialchars($attendance_record['attendance_status']); ?></span>
                                </div>

                                <form method="POST" action="request_correction.php">
                                    <input type="hidden" name="attendance_id"
                                        value="<?php echo $attendance_record['id']; ?>">
                                    <input type="hidden" name="student_name"
                                        value="<?php echo htmlspecialchars($attendance_record['student_name']); ?>">
                                    <input type="hidden" name="roll_number"
                                        value="<?php echo htmlspecialchars($attendance_record['roll_number']); ?>">
                                    <input type="hidden" name="subject_name"
                                        value="<?php echo htmlspecialchars($attendance_record['subject_name']); ?>">
                                    <input type="hidden" name="date_of_attendance"
                                        value="<?php echo htmlspecialchars($attendance_record['date_of_attendence']); ?>">
                                    <input type="hidden" name="current_status"
                                        value="<?php echo htmlspecialchars($attendance_record['attendance_status']); ?>">

                                    <div class="mb-3">
                                        <label class="form-label fw-semibold small text-secondary">REQUESTED NEW ATTENDANCE
                                            STATUS</label>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label fw-semibold small text-secondary">REASON FOR CORRECTION /
                                            RE-MARKING</label>
                                        <textarea name="reason" rows="3" class="form-control"
                                            placeholder="Explain the error..." required></textarea>
                                    </div>
                    ...
                    <div class="tab-pane fade <?php echo $active_tab === 'bulk' ? 'show active' : ''; ?>"
                        id="bulkCorrection" role="tabpanel">
                        <!-- Bulk Search Card -->
                        <div class="form-card card p-4 mb-4">
                            <h4 class="fw-bold text-dark mb-3"><i
                                    class="fa-solid fa-users-rectangle me-2 text-primary"></i>Find Entire Class
                                Attendance</h4>
                            <form method="POST" action="request_correction.php">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold small text-secondary">SELECT
                                            SUBJECT</label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold small text-secondary">DATE OF ATTENDANCE
                                            (DDMMYY format)</label>
                                        <input type="text" name="bulk_date_of_attendance" class="form-control"
                                            placeholder="e.g., 140726" required
                                            value="<?php echo isset($_POST['bulk_date_of_attendance']) ? htmlspecialchars($_POST['bulk_date_of_attendance']) : ''; ?>">
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" name="search_bulk_attendance"
                                            class="btn btn-primary w-100 fw-bold"><i
                                                class="fa-solid fa-users me-2"></i>Fetch Class Records</button>
                                    </div>
                                </div>
                            </form>
                            <?php if (!empty($bulk_search_error)) {
                                echo "<div class='alert alert-danger mt-3 small py-2'>$bulk_search_error</div>";
                            } ?>
                        </div>
                            ...
                            <div class="form-card card p-4">
                                <form method="POST" action="request_correction.php">
                                    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
                                        <div>
                                            <h4 class="fw-bold text-success mb-0"><i
                                                    class="fa-solid fa-list-check me-2"></i>Class Attendance Grid</h4>
                                            <small class="text-secondary">Only changed rows will submit a request.</small>
                                        </div>
                                        <!-- Global reason helper tool -->
                                        <div class="d-flex gap-2 align-items-center">
                                            <input type="text" id="global_reason" class="form-control form-control-sm"
                                                style="max-width: 250px;"
                                                placeholder="Fast fill: Reason for all changed...">
                                            <button type="button" class="btn btn-secondary btn-sm fw-bold"
                                                onclick="applyGlobalReason()"><i
                                                    class="fa-solid fa-copy me-1"></i>Apply</button>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($bulk_attendance_records as $record) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span
                                                                class="fw-bold d-block text-dark"><?php echo htmlspecialchars($record['student_name']); ?></span>
                                                            <span class="badge bg-light text-dark border small">Roll:
                                                                <?php echo htmlspecialchars($record['roll_number']); ?></span>
                                                        ...
                                                        <td class="text-center">
                                                            <?php if ($record['attendance_status'] === 'Present') { ?>
                                                                <span
                                                                    class="badge bg-success-subtle text-success px-3 py-2 border border-success-subtle">Present</span>
                                                            <?php } else { ?>
                                                                <span
                                                                    class="badge bg-danger-subtle text-danger px-3 py-2 border border-danger-subtle">Absent</span>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                            <select name="requested_statuses[<?php echo $id; ?>]"
                                                                class="form-select form-select-sm status-select"
                                                                onchange="toggleReasonRequired(this, '<?php echo $id; ?>')">
                                                        ...
                                                        <td>
                                                            <input type="text" id="reason_<?php echo $id; ?>"
                                                                name="reasons[<?php echo $id; ?>]"
                                                                class="form-control form-control-sm bulk-reason-input"
                                                                placeholder="Required if changed...">
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                    ...
                                    <button type="submit" name="submit_bulk_correction"
